...
unmatched.low <- read.csv("raw-results/unmatched_0.001.csv")
unmatched.high <- read.csv("raw-results/unmatched_0.01.csv")


## Matched Design Results

matched.low <- read.csv("raw-results/matched_0.001.csv")
matched.high <- read.csv("raw-results/matched_0.01.csv")


## Sensitivity Analysis Results

moderate.m <- read.csv("moderate_m_0.001_0.06.csv")
large.m <- read.csv("large_m_0.001_0.06.csv")
frequency <- read.csv("freq_0.001_0.06.csv")
re <- read.csv("re_0.001_0.25.csv")
...
l.mi <- format_plot_data(unmatched.low[unmatched.low$f.theta==0.06 & abs(log(unmatched.low$h)) < 0.9, ], TRUE)
