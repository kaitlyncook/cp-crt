#-----------------------------------------------------------------------------------------------------#
#   Simulation Studies: Sample Simulation Script for Cluster Size Sensitivity Analysis                #
#-----------------------------------------------------------------------------------------------------#
...
#     c) a null intervention effect (\beta = 0),
#     d) M=90 randomized clusters, and 
#     e) an unmatched CRT design.
# To obtain all simulation replicates for this single simulation setting, this script must be run 
# 125 times; the full sensitivity analysis considers six such simulation settings. Wherever possible, I 
# have marked where the variables in the sample simulation script may be changed in order to obtain the 
...
# Number of clusters
M <- 90                     ## Setting 2: M <- 300       

# Cluster size
ni <- c(50, 150)            ## Setting 2: ni <- c(10, 50)
