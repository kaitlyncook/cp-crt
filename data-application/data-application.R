...
source("../cp-simulation-functions.R")
...
int.data <- read.csv("simulated-bcpp.csv")
...
set.seed(101)
start.1.1 <- Sys.time()
cp.1.1 <- est_cp(int.data, 78, c(52, 104, 156), 4, 1, 1, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
end.1.1 <- Sys.time()
...
cp.1.0.8 <- est_cp(int.data, 78, c(52, 104, 156), 4, 1, 0.8, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
end.1.0.8 <- Sys.time()
...
cp.1.0.9 <- est_cp(int.data, 78, c(52, 104, 156), 4, 1, 0.9, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
end.1.0.9 <- Sys.time()
...
cp.1.1.1 <- est_cp(int.data, 78, c(52, 104, 156), 4, 1, 1.1, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
end.1.1.1 <- Sys.time()
...
cp.1.1.2 <- est_cp(int.data, 78, c(52, 104, 156), 4, 1, 1.2, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
end.1.1.2 <- Sys.time()
...
cp.0.9.1 <- est_cp(int.data, 78, c(52, 104, 156), 4, 0.9, 0.9*1, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
end.0.9.1 <- Sys.time()
...
cp.0.9.0.8 <- est_cp(int.data, 78, c(52, 104, 156), 4, 0.9, 0.9*0.8, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
...
cp.0.9.0.9 <- est_cp(int.data, 78, c(52, 104, 156), 4, 0.9, 0.9*0.9, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
...
cp.0.9.1.1 <- est_cp(int.data, 78, c(52, 104, 156), 4, 0.9, 0.9*1.1, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
...
cp.0.9.1.2 <- est_cp(int.data, 78, c(52, 104, 156), 4, 0.9, 0.9*1.2, matched_analysis, 0.05, 1000, cens=0.002, trunc.time=78)
